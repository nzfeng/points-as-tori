...
class BVH {
  public:
    ...
    std::pair<Eigen::VectorXi, Eigen::VectorXd> find_points_in_radius(const Eigen::Vector3d& query,
                                                                      double radius) const;
    ...
    BVHPrimitiveType get_primitive_type() const {
  ...
  private:
    ...
    bool intersect_triangle(const Eigen::Vector3d& ray_origin, const Eigen::Vector3d& ray_dir,
